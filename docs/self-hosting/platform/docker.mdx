...
<Callout type="tip">
  If you want to build your own Docker image from source code, see the [Building Your Own Docker Image](/docs/self-hosting/advanced/docker-build) documentation.
</Callout>
