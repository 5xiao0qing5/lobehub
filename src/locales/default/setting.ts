...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'storage.actions.export.exportType.all': 'Export All Data',
  ...
  'storage.actions.export.exportType.conversations': 'Export Conversations',
  'storage.actions.export.exportType.conversations.desc':
    'Sessions, agents, topics, and messages',
  'storage.actions.export.exportType.globalSetting': 'Export Global Settings',
  'storage.actions.export.exportType.settings': 'Export Settings',
  'storage.actions.export.exportType.settings.desc':
    'User settings, API keys, AI models, and providers',
